...
func createRender() multitemplate.Renderer {
	...
	renderer.AddFromFiles("login-form", "views/layouts/default.html","views/layouts/header.html", "views/layouts/footer.html","views/auth/login-form.html")
	renderer.AddFromFiles("register-form", "views/layouts/default.html","views/layouts/header.html", "views/layouts/footer.html","views/auth/register-form.html")
	renderer.AddFromFiles("register-callback", "views/layouts/default.html","views/layouts/header.html", "views/layouts/footer.html","views/auth/register-callback.html")
